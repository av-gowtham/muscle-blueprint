  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap ">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        ...
        <h2 className="capitalize whitespace-nowrap truncate text-lg sm:text-xl md:text-2xl flex-1 sm:text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        {["reps", "rest", "tempo"].map((info) => {
          return (
            <div
              className="flex flex-col p-2 rounded border-2 border-solid border-blue-900 w-full"
              key={info}
            >
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-2 border-solid border-blue-900 hover:border-blue-400 w-full duration-200"
        >
